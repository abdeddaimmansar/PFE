 ...
 if($_SESSION['loggedin']== false)
 {
   header("location: logout.php");
      ...
      if(ISSET($_GET['id_vol']))
      {
           ...
           $cin = $_GET['id_vol'];
           include("Volume.php");
           $student = new dictionnaire();
          $fetch = $student->getdic($cin);
        ...
        <li class="submenu">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Edit Dictionnaire</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="students.php">Dictionnaire</a></li>
									<li class="breadcrumb-item active">Edit Dictionnaire</li>
								</ul>
							</div>
						</div>
					</div>
          ...
          <div class="row">
						<div class="col-sm-12">
							...
							<div class="card">
								<div class="card-body">
									<form action="saveDic.php" method="POST" enctype="multipart/form-data">
										<div class="row">
											<div class="col-12">
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="language" class="form-control">
                            <option selected><?php echo $fetch["language"]; ?> </option>
                            <option>Arabe </option>
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <img width="100" src='<?php echo $fetch["image_v"];$_SESSION['image_v'] = $fetch["image_v"]; ?>' class="avatar-img rounded-circle" >
                          <input type="file" name="image" class="form-control" >
											...
											<div class="col-12">
												<button type="submit" name="updatedic" class="btn btn-primary">Modifier</button>
											</div>

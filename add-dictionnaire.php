                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Add dictionnaire</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dictionnaire.php">dictionnaire</a></li>
									<li class="breadcrumb-item active">Add dictionnaire</li>
								</ul>
							</div>
						</div>
					</div>

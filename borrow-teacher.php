          ...
          <div class="row">
							...
							<div class="card">
								<div class="card-body">
									<form action="borrow.php" method="POST" enctype="multipart/form-data">
										<div class="row">
											<div class="col-12">
												<h5 class="form-title"><span>Volume Information</span></h5>
											</div>
                        ...
                        <img width=50 src='<?php echo $_SESSION['fetch']["image"]; ?>' class="form-control" >
                          <input type="file" name="photo" class="form-control" >
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>titre</label>
													<input type="text" name="nom" class="form-control" value=" <?php echo $_SESSION['fetch']["titre"]; ?>">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													...
													<input type="text" name="prenom" class="form-control" value="<?php echo $_SESSION['fetch']["auteur"]; ?>" >
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>ID</label>
													<input type="text" name="id" class="form-control" value="<?php echo $_SESSION['fetch']["id_vol"]; ?>">
												</div>
											</div>
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tele" class="form-control" value="<?php echo $_SESSION['fetch']["emplacement"]; ?>">
                        </div>
                      </div>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            <label>Nom</label>
                            <input type="text" name="nom" class="form-control" value="<?php  echo $liste["nom_Adh"]; ?>">
                          </div>
                        </div>
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            <label> CIN</label>
                            <input type="text" name="cin" class="form-control" value="<?php echo $liste["cin"]; ?>">
                          </div>
                        </div>
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            ...
                            <select name="depar" class="form-control">
                              <option disabled="" value="<?php echo $liste["depar"]; ?>" >select</option>
                              <option>GI</option>
                              <option>TM</option>
                              <option>GIM</option>
                              <option>TIMQ</option>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="tele" class="form-control" value="<?php echo $liste["tele"]; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="email" class="form-control" value="<?php echo $liste["email"]; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="nbr_emprunt" class="form-control" value="<?php echo $liste["nbr_emprunt"]; ?>">
                          </div>
                        </div>
                        <div class="col-12 col-sm-6">
                          <div class="form-group">
                        ...
                        <div class="col-12 form-group">
                          <button type="submit" name="borrowTeacher" class="btn btn-primary">borrow to this student</button>

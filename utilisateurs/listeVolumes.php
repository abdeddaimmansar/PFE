...
<?php
     ...
     if(isset($_GET['id_cat'])){
      ...
      $sql = "SELECT  titre, image, auteur, editeur, STATUS FROM volume WHERE categorie=? ORDER BY titre";
        ...
        <?php
            foreach ($result as $output ) {?>
                <div  class="card col-4 col-md-3 ">
                    <a    href="#" >
                        <div class="car">
                            <img src="/Admin/<?php echo $output["titre"];?>" class="card-img-top " alt="..." height="250px" width="100px">

        ...
        <div class="content container-fluid">
            ...
            <div class="row cards d-flex justify-content-around ">
                <?php
                    ...
                    <ul  >
                        <li class="booking-card" style="background-image: url(/Admin/<?php echo $output["image"];?>); background-position: center;">
                            <div class="book-container">
                                <div class="content">
                                    <a href="listeLivre_Polycope.php?categorie=<?php echo $output["liblecat"];?>">
                                ...
                                <div class="more-information">
                                    <div class="info-and-date-container">
                                        ...
                                        <svg class="icon" style="width:24px;height:24px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                                            ...
                                            <p>Il y a <?php $cate= $output["liblecat"]; $count1 = $cat->nbrLivres($cate); echo  '<span style="color:red;">'.$count1.'</span>' ;?> Livres</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="more-information">
                                    <div class="info-and-date-container">
                                       ...
                                       <p>Il y a <?php $cate= $output["liblecat"]; $count2 = $cat->nbrPolycopes($cate); echo '<span style="color:red;">'.$count2.'</span>' ;?>  Polycopes</p>
                                        </div>
                                    </div>
                                </div>
                            </div>

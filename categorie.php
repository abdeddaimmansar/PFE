...
<a href="add-categorie.php" class="btn btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
</div>
<!-- /Page Header -->
...
<td>".$ls[0]."</td>
<td>".$ls[1]. " </td>
<td><a href='edit-categorie.php?id_Adh=$ls[0]' class='btn btn-sm bg-success-light mr-2'>
<i class='fas fa-pen'></i>
</a>
<a href='delete-categorie.php?id_Adh=$ls[0]' class='btn btn-sm bg-danger-light'>

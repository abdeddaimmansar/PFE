            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="row">
                        ...
                        ?>
                          <tr>
                         <td><?php echo $ls["id_Cat"];?></td>
                          <td><img src="<?php echo $ls["image"]; ?>" width="80" alt="User Image" class="avatar-img ">
</td>                        <td><?php echo $ls["liblecat"] ?></td>
                      <td class="text-right">
                        <div class="actions">
                            <a href="edit-categorie.php?id_Cat=<?=$ls["id_Cat"]?>" class="btn btn-sm bg-success-light mr-2">
                               <i class="fas fa-pen"></i>
                            </a>
                              <a href="delete-volume.php?id_Cat=<?=$ls["id_Cat"]?>"  class="btn btn-sm bg-danger-light">

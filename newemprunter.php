          ...
          <div class="row">
                        ...
                        <img width=50 src='<?php echo $fetch["image"]; ?>' class="form-control" >
                          <input type="file" name="photo" class="form-control" >
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>titre</label>
													<input type="text" name="nom" class="form-control" value=" <?php echo $fetch["titre"]; ?>">
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													...
													<input type="text" name="prenom" class="form-control" value="<?php echo $fetch["auteur"]; ?>" >
												</div>
											</div>
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>ID</label>
													<input type="text" name="id" class="form-control" value="<?php echo $fetch["id_vol"]; ?>">
												</div>
											</div>
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tele" class="form-control" value="<?php echo $fetch["emplacement"]; ?>">
                        </div>
                      </div>
                        </div>

                        <div class="col-12 form-group">
                          <button type="submit" name="student" class="btn btn-primary">add to student</button>
                        </div>
                        <div class="col-12 form-group">
                          <button type="submit" name="teacher" class="btn btn-primary">add to teacher</button>
                        </div>

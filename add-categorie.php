...
<div class="content container-fluid">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Add Catégories</h3>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="categorie.php">Catégories</a></li>
					<li class="breadcrumb-item active">Add Catégories</li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			<h5 class="form-title"><span>Catégorie Information</span></h5>
		</div>
		...
		<div class="col-12 col-sm-6">
			<div class="form-group">
				<label>Libelle</label>
				<input type="text" name="txtlib" class="form-control">
			</div>
		</div>
